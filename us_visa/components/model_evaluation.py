...
from us_visa.entity.artifact_entity import ModelTrainerArtifact, ModelEvaluationArtifact, DataIngestionArtifact
...
class ModelEvaluation:
    def __init__(self, model_eval_config: ModelEvaluationConfig, data_ingestion_artifact: DataIngestionArtifact,
        ...
        try:
            ...
            logging.error(f"Error during model evaluation initialization: {e}")
    ...
    def evaluate_model(self) -> ModelEvaluationResponse:
        try:
            ...
            logging.info(f"Model evaluation completed. Model evaluation artifact: {result}")
            return result
        except Exception as e:
    ...
    def initiate_model_evaluation(self) -> ModelEvaluationArtifact:
        try:
            ...
            logging.error(f"Error during model evaluation initiation: {e}")
            raise USVisaException(e, sys)